 ...
 *  ï LFX-Indizes: LiteForex (gestauchte FX6-Indizes, auﬂer NZDLFX=NZDFX7)
 *  ï FX6-Indizes: AUDFX6, CADFX6, CHFFX6, EURFX6, GBPFX6, JPYFX6, USDFX6
 *  ï FX7-Indizes: AUDFX7, CADFX7, CHFFX7, EURFX7, GBPFX7, JPYFX7, USDFX7, NOKFX7, NZDFX7, SEKFX7, SGDFX7, ZARFX7
 *  ï ICE-Indizes: EURX, USDX
 *
...
// Indizes und die zu ihrer Berechnung benˆtigten Instrumente
...
function updateIndex($index) {
   ...
   // (1) Starttag der benˆtigten Daten ermitteln
   $startTime = 0;
   ...
   for ($day=$startDay, $lastMonth=-1; $day < $today; $day+=1*DAY) {
      ...
      if (!MyFX::isForexWeekend($day, 'FXT')) {                               // um 00:00 GMT sind GMT- und FXT-Wochentag immer gleich
         ...
         if (is_file($file=getVar('myfxTarget.compressed', $index, $day))) {
            ...
            // History aktualisieren: M1-Bars der benˆtigten Instrumente dieses Tages einlesen
            foreach($pairs as $pair => $data) {
