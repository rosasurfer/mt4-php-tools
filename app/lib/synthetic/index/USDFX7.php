 ...
 * USDFX7 synthesizer
 *
 * A {@link Synthesizer} for calculating the US Dollar FX7 index.
 *
 * <pre>
 * Formula:
 * --------
 * USDFX7 = pow(USDCAD * USDCHF * USDJPY / (AUDUSD * EURUSD * GBPUSD * NZDUSD), 1/7)
 * </pre>
 */
class USDFX7 extends AbstractSynthesizer {
    ...
    public function calculateQuotes($day) {
        ...
        foreach ($AUDUSD as $i => $bar) {
            ...
            $open   = pow($usdcad * $usdchf * $usdjpy / ($audusd * $eurusd * $gbpusd * $nzdusd), 1/7);
            ...
            $close  = pow($usdcad * $usdchf * $usdjpy / ($audusd * $eurusd * $gbpusd * $nzdusd), 1/7);
