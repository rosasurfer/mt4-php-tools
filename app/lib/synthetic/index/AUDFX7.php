 ...
 * Formulas:
 * ---------
 * AUDFX7 = pow(USDCAD * USDCHF * USDJPY / (EURUSD * GBPUSD * NZDUSD), 1/7) * AUDUSD        // majors
 * AUDFX7 = pow(AUDCAD * AUDCHF * AUDJPY * AUDNZD * AUDUSD / (EURAUD * GBPAUD), 1/7)        // crosses
 * </pre>
 */
class AUDFX7 extends AbstractSynthesizer {
    ...
    public function calculateQuotes($day) {
        ...
        foreach ($AUDUSD as $i => $bar) {
            ...
            $open   = pow($usdcad * $usdchf * $usdjpy / ($eurusd * $gbpusd * $nzdusd), 1/7) * $audusd;
            ...
            $close  = pow($usdcad * $usdchf * $usdjpy / ($eurusd * $gbpusd * $nzdusd), 1/7) * $audusd;
